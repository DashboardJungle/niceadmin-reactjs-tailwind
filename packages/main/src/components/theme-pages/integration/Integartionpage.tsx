...
function Integartionpage() {
    ...
    return (
        <CardBox>
                    ...
                    <CardBox key={idx} className="p-0">
                        ...
                        <div className="flex items-center justify-between border-t border-border dark:border-darkborder  p-5 ">
                            <div className="flex gap-3">
                                <Button color="light" className="text-link dark:text-darklink" onClick={() => setShowSettingModal(true)}>
                                    <Icon icon="lucide:settings" width={19} height={19} />
                                </Button>
                                <Button color="light" className="text-link dark:text-darklink text-center leading-0" onClick={() => setShowDetailModal(true)}>
                                    Details
                                </Button>
                            </div>
                            <div>
            ...
            <NewIntegrationModal open={showNewIntegrationModal} onClose={() => setShowNewIntegrationModal(false)} />
