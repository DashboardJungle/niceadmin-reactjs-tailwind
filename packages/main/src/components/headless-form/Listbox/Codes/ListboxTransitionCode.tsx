    ...
    <>
      <Listbox value={selectedPerson} onChange={setSelectedPerson}>
        ...
        <ListboxOptions
          anchor="bottom"
          transition
          className="ui-dropdown origin-top transition duration-200 ease-out data-[closed]:scale-95 data-[closed]:opacity-0"
        >
          {people.map((person) => (
...
export default ListboxTransitionCode;
