...
let MyCustomButton = forwardRef<HTMLButtonElement, MyCustomButtonProps>(function MyCustomButton(
  props,
  ref,
) {
...
const RenderingAsDiffElemtnsCode = () => {
    ...
    <>
      <Listbox value={selectedPerson} onChange={setSelectedPerson}>
        ...
        <ListboxOptions anchor="bottom" as="ul" className="ui-dropdown">
          {people.map((person) => (
            <ListboxOption as="li" key={person.id} value={person} className="ui-dropdown-item">
              {person.name}
            </ListboxOption>
          ))}
        </ListboxOptions>
...
export default RenderingAsDiffElemtnsCode;
