      ...
      <div className='max-w-sm'>
        <Combobox
          ...
          <div className='relative'>
            ...
            />
            <ComboboxButton className='group absolute inset-y-0 right-0 px-2.5 hover:cursor-pointer'>
          ...
          <ComboboxOptions
            ...
            transition
            className={clsx(
              'absolute z-10 mt-1 max-h-60 w-[var(--input-width)] overflow-auto rounded-md bg-white dark:bg-dark py-1 text-base shadow-md dark:shadow-dark-md ring-1 ring-black/10 dark:ring-white/20 focus:outline-none sm:text-sm',
            ...
            {filteredPeople.map((person) => (
              <ComboboxOption
                ...
                <Icon
                  ...
                  className='invisible  group-data-[selected]:visible dark:group-data-[selected]:text-white'
                  height={20}
                />
                <div className='text-sm text-ld hover:text-primary dark:hover:text-white data-[focus]:text-primary'>
                  {person.name}
                </div>
              </ComboboxOption>
            ))}
