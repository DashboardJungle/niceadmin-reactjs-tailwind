...
const ContactListItem: React.FC<ContactListItemProps> = ({
  ...
  const [contactToDelete, setContactToDelete] = useState<string | null>(null)  //contact ID to delete
                  ...
                  <div className='p-5'>
                    <div className='flex gap-3 items-center'>
                      ...
                      <div>
                        ...
                        <p className='text-xs'>{selectedContact.department}</p>
                        <p className='text-xs'>{selectedContact.company}</p>
                      </div>
                    </div>
