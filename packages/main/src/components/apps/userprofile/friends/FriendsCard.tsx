              ...
              <div
                ...
                <CardBox className='px-0 pb-0  text-center overflow-hidden'>
                  ...
                  <div>
                    ...
                    <p className='text-xs text-black dark:text-darklink'>
                      {profile.role}
                    </p>
                  </div>
                  <div className='flex justify-center gap-4 items-center border-t border-ld mt-4 pt-4 pb-4 bg-neutral-50 dark:bg-white/10'>
