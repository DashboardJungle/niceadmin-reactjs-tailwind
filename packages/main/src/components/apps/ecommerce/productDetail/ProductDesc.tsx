    ...
    <Tabs aria-label="Tabs with underline" variant="underline">
      <TabItem active title="Discription">
        <div className="py-4">
          ...
          <p className="text-sm text-black/50 dark:text-darklink mb-6">
              ...
              <OutlineCard className="shadow-none">
                <div className="flex flex-col gap-3 ">
                  <div className="flex items-center gap-5">
                    <span className="text-black/50 dark:text-darklink text-xs">1 Stars</span>
                    <div className="grow ">
                  ...
                  <div className="flex items-center gap-5">
                    <span className="text-black/50 dark:text-darklink text-xs">2 Stars</span>
                    <div className="grow ">
                  ...
                  <div className="flex items-center gap-5">
                    <span className="text-black/50 dark:text-darklink text-xs">3 Stars</span>
                    <div className="grow ">
                  ...
                  <div className="flex items-center gap-5">
                    <span className="text-black/50 dark:text-darklink text-xs">4 Stars</span>
                    <div className="grow ">
                  ...
                  <div className="flex items-center gap-5">
                    <span className="text-black/50 dark:text-darklink text-xs">5 Stars</span>
                    <div className="grow ">
