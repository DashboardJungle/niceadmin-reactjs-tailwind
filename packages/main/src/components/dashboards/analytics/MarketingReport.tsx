  ...
  return (
    <>
      <CardBox>
            ...
            <div className="flex flex-col gap-6">
              {MarketingData.map((item, index) => (
                <div key={index} className="flex gap-3 items-center">
                  <span
                    className={`w-14 h-10 rounded-full flex items-center justify-center  bg-light${item.color} dark:bg-black${item.color} text-${item.color}`}
                  >
        ...
        <div className="bg-muted dark:bg-black rounded-tw py-3 px-[18px] flex justify-between items-center mt-6">
