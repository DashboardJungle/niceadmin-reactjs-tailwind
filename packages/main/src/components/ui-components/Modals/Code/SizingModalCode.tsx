  ...
  return (
    <>
      <div className="flex items-center flex-wrap gap-4">
        ...
        <Button onClick={() => setSizeModal(true)} className="w-fit" color="success">
          Toggle Modal
        </Button>
      </div>
      <Modal show={sizeModal} size={modalSize} onClose={() => setSizeModal(false)}>
        ...
        <ModalFooter>
          <Button color="primary" onClick={() => setSizeModal(false)}>
            I accept
          </Button>
          <Button color="error" onClick={() => setSizeModal(false)}>
            Decline
          </Button>
        </ModalFooter>
      </Modal>
...
export default SizingModalCode;
